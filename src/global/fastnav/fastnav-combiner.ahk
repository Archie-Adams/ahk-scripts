...
FileRead, OutputVar, .\example.json


HTML := "<script>" jsonlib . JS "</script>"
Gui, Add, ActiveX, vWB, about:<!DOCTYPE html>
WB.Document.Open(), WB.Document.Write(HTML), WB.Document.Close()
MsgBox, % WB.Document.parentWindow.d(OutputVar)
...
file := FileOpen(".\fastnav.ahk", "w")
file.Write(OutputVar)
file.Write(fastnavhead)
file.Close()