...
;  --------------------------------------------------------------------------  ;
;                   ! HOTKEYS CHANGED FROM ORIGANAL SCRIPT !                   ;
;  --------------------------------------------------------------------------  ;
...
; TODO: Implement scooting
; TODO: Implement browser detaching
; HOW: https://github.com/glenviewjeff/HyperWindowSnap

; TODO: Implement 2 thirds docking (left, right, up, down)
